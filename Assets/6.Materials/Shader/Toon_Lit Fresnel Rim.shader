	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.xyz = tmp0.xyz * _RimGlow.xxx;
                tmp2.xyz = _RimColor.xyz * _RimTween.xxx;
                tmp2.xyz = tmp2.xyz * _BaseGlow.xxx;
                tmp0.xyz = tmp0.xyz * _RimTween.xxx + tmp2.xyz;
                ...
                tmp2 = tex2D(_Ramp, tmp1.ww);
                tmp3.xyz = tmp1.xyz * _LightColor0.xyz;
                tmp2.xyz = tmp2.xyz * tmp3.xyz;
                tmp2.xyz = tmp0.www * tmp2.xyz;
                tmp1.xyz = tmp1.xyz * inp.texcoord3.xyz + tmp2.xyz;
