	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp3.xyz = tmp2.xyz * inp.texcoord3.xyz;
                ...
                tmp2.xyz = tmp2.xyz * inp.texcoord3.xyz + float3(-0.04, -0.04, -0.04);
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp4.xyz = tmp3.xyz * inp.texcoord3.xyz;
                ...
                tmp3.xyz = tmp3.xyz * inp.texcoord3.xyz + float3(-0.04, -0.04, -0.04);
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1.xyz = tmp0.xyz * inp.texcoord3.xyz;
                tmp0.xyz = tmp0.xyz * inp.texcoord3.xyz + float3(-0.04, -0.04, -0.04);
