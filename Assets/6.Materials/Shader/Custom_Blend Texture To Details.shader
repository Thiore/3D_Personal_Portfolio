	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp3 = tex2D(_Detail, inp.texcoord.zw);
                tmp2.xyz = tmp2.xyz * _Color.xyz;
                tmp3.xyz = tmp3.xyz * float3(4.0, 4.0, 4.0) + float3(-1.0, -1.0, -1.0);
                tmp3.xyz = inp.color.xxx * tmp3.xyz + float3(1.0, 1.0, 1.0);
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp4 = tex2D(_Detail, inp.texcoord.zw);
                tmp3.xyz = tmp3.xyz * _Color.xyz;
                tmp4.xyz = tmp4.xyz * float3(4.0, 4.0, 4.0) + float3(-1.0, -1.0, -1.0);
                tmp4.xyz = inp.color.xxx * tmp4.xyz + float3(1.0, 1.0, 1.0);
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                float4 tmp0;
                float4 tmp1;
                tmp0 = tex2D(_Detail, inp.texcoord.zw);
                tmp0.xyz = tmp0.xyz * float3(4.0, 4.0, 4.0) + float3(-1.0, -1.0, -1.0);
                tmp0.xyz = inp.color.xxx * tmp0.xyz + float3(1.0, 1.0, 1.0);
