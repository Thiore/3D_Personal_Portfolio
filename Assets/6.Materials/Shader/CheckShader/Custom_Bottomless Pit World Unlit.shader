	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.w = 1.0 - _Saturation;
                tmp0.xyz = tmp0.www * tmp0.xyz + tmp1.xyz;
                tmp1.xy = inp.texcoord2.yz + -float2(_HeightStart.x, _ZStart.x);
                ...
                tmp1.xzw = _ZColorNight.xyz - _ZColor.xyz;
                tmp1.xzw = _Night.xxx * tmp1.xzw + _ZColor.xyz;
                tmp0.xyz = tmp0.xyz - tmp1.xzw;
                o.sv_target3.xyz = tmp1.yyy * tmp0.xyz + tmp1.xzw;
                o.sv_target3.w = 1.0;
                return o;
			}
			ENDCG
