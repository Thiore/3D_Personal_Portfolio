	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp8.xyz = float3(1.0, 1.0, 1.0) - tmp2.xyz;
                tmp0.xyw = tmp8.xyz * tmp0.xxx + tmp2.xyz;
                tmp0.xyw = tmp0.xyw * tmp5.xyz;
                tmp0.xyw = tmp6.xyz * tmp4.xyz + tmp0.xyw;
                ...
                o.sv_target.xyz = tmp3.xyz * _Ambience.xyz + tmp0.xyz;
                o.sv_target.w = 1.0;
                return o;
			}
			ENDCG
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.xyz = tmp0.yzw * _Ambience.xyz;
