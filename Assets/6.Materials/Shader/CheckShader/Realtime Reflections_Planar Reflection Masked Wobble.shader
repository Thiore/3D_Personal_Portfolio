	...
	SubShader {
		...
		Pass {
			...
			v2f vert(appdata_full v)
			{
                ...
                o.texcoord.zw = v.texcoord.xy * _WobbleTex_ST.xy + _WobbleTex_ST.zw;
			...
			fout frag(v2f inp)
			{
                ...
                float4 tmp1;
                float4 tmp2;
                tmp0.xy = _Time.xx * _WobbleSpeed.xx + inp.texcoord.zw;
                tmp0 = tex2D(_WobbleTex, tmp0.xy);
                tmp0.x = tmp0.w * tmp0.x;
                tmp0.xy = tmp0.xy * float2(2.0, 2.0) + float2(-1.0, -1.0);
                tmp1 = tex2D(_MainTex, inp.texcoord.xy);
                tmp0.z = tmp1.x * _NoisePercent;
                tmp1.xyz = _NoiseTint.xyz - _TintColor.xyz;
                tmp1.xyz = tmp0.zzz * tmp1.xyz + _TintColor.xyz;
                tmp1.xyz = tmp1.xyz * _MainAlpha.xxx;
                tmp0.xy = tmp0.xy * _WobbleStrength.xx + inp.texcoord3.xy;
                ...
                tmp0.xyz = tmp0.xyz * _ReflectionAlpha.xxx + -tmp2.xyz;
                tmp0.xyz = _ReflectTween.xxx * tmp0.xyz + tmp2.xyz;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1 = tex2D(_MainTex, inp.texcoord.xy);
                tmp0.w = tmp1.x * _NoisePercent;
                tmp1.xyz = _NoiseTint.xyz - _TintColor.xyz;
                tmp1.xyz = tmp0.www * tmp1.xyz + _TintColor.xyz;
                tmp1.xyz = tmp1.xyz * _MainAlpha.xxx;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.x = tmp0.w * tmp0.x;
                tmp0.xy = tmp0.xy * float2(2.0, 2.0) + float2(-1.0, -1.0);
                tmp0.xy = tmp0.xy * _WobbleStrength.xx + inp.texcoord2.xy;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.x = tmp0.x * _NoisePercent;
                tmp0.yzw = _NoiseTint.xyz - _TintColor.xyz;
                tmp0.xyz = tmp0.xxx * tmp0.yzw + _TintColor.xyz;
                o.sv_target.xyz = tmp0.xyz * _MainAlpha.xxx;
                o.sv_target.w = 1.0;
