Shader "Realtime Reflections/Ice Reflection Masked" {
	...
	SubShader {
		...
		Pass {
			...
			float _ReflectNoiseAlpha;
			float _ReflectNoiseAlphaAdd;
			float4 _TintColor;
			float4 _PreTintColor;
			...
			v2f vert(appdata_full v)
			{
                ...
                o.texcoord.zw = v.texcoord.xy * _DistortTex_ST.xy + _DistortTex_ST.zw;
			...
			fout frag(v2f inp)
			{
                ...
                float4 tmp1;
                float4 tmp2;
                tmp0 = tex2D(_DistortTex, inp.texcoord.zw);
                tmp0.x = tmp0.w * tmp0.x;
                tmp0.xy = tmp0.xy * float2(2.0, 2.0) + float2(-1.0, -1.0);
                tmp1 = tex2D(_MainTex, inp.texcoord.xy);
                tmp0.zw = inp.texcoord.xy * _NoiseScale.xx;
                tmp2 = tex2D(_DistortTex, tmp0.zw);
                tmp2.yzw = _PreTintColor.xyz - tmp1.xyz;
                tmp1.xyz = _MainAlpha.xxx * tmp2.yzw + tmp1.xyz;
                tmp1.xyz = tmp1.xyz * _PreTintColor.xyz;
                tmp0.z = tmp2.x - 1.0;
                tmp0.z = _ReflectNoiseAlpha * tmp0.z + 1.0;
                tmp0.z = saturate(tmp0.z - _ReflectNoiseAlphaAdd);
                tmp0.xy = tmp0.xy * _DistortStrength.xx + inp.texcoord3.xy;
                tmp0.xy = tmp0.xy / inp.texcoord3.ww;
                tmp2 = tex2D(_ReflectionTex, tmp0.xy);
                tmp0.xyw = _AltReflectionColorNight.xyz - _AltReflectionColor.xyz;
                tmp0.xyw = _Night.xxx * tmp0.xyw + _AltReflectionColor.xyz;
                tmp2.xyz = tmp2.xyz * _ReflectionAlpha.xxx + -tmp0.xyw;
                tmp0.xyw = _ReflectTween.xxx * tmp2.xyz + tmp0.xyw;
                tmp0.xyw = tmp0.xyw - _TintColor.xyz;
                tmp0.xyz = tmp0.zzz * tmp0.xyw + _TintColor.xyz;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1 = tex2D(_MainTex, inp.texcoord.xy);
                tmp2.xyz = _PreTintColor.xyz - tmp1.xyz;
                tmp1.xyz = _MainAlpha.xxx * tmp2.xyz + tmp1.xyz;
                tmp1.xyz = tmp1.xyz * _PreTintColor.xyz;
		...
		Pass {
			...
			v2f vert(appdata_full v)
			{
                ...
                o.texcoord5.xyz = tmp1.xyz + tmp2.xyz;
                return o;
			}
			// Keywords: 
			fout frag(v2f inp)
			{
                ...
                tmp0.x = tmp0.w * tmp0.x;
                tmp0.xy = tmp0.xy * float2(2.0, 2.0) + float2(-1.0, -1.0);
                tmp0.xy = tmp0.xy * _DistortStrength.xx + inp.texcoord2.xy;
                ...
                tmp0.xyz = tmp0.xyz * _ReflectionAlpha.xxx + -tmp1.xyz;
                tmp0.xyz = _ReflectTween.xxx * tmp0.xyz + tmp1.xyz;
                tmp0.xyz = tmp0.xyz - _TintColor.xyz;
                tmp1.xy = inp.texcoord.xy * _NoiseScale.xx;
                tmp1 = tex2D(_DistortTex, tmp1.xy);
                tmp0.w = tmp1.x - 1.0;
                tmp0.w = _ReflectNoiseAlpha * tmp0.w + 1.0;
                tmp0.w = saturate(tmp0.w - _ReflectNoiseAlphaAdd);
                tmp0.xyz = tmp0.www * tmp0.xyz + _TintColor.xyz;
                tmp1 = tex2D(_MainTex, inp.texcoord.xy);
                tmp2.xyz = _PreTintColor.xyz - tmp1.xyz;
                tmp1.xyz = _MainAlpha.xxx * tmp2.xyz + tmp1.xyz;
                tmp1.xyz = tmp1.xyz * _PreTintColor.xyz;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1.xyz = _PreTintColor.xyz - tmp0.xyz;
                tmp0.xyz = _MainAlpha.xxx * tmp1.xyz + tmp0.xyz;
                o.sv_target.xyz = tmp0.xyz * _PreTintColor.xyz;
                o.sv_target.w = 1.0;
