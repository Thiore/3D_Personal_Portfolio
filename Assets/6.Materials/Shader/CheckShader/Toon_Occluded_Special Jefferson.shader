	...
	SubShader {
		...
		Pass {
			...
			v2f vert(appdata_full v)
			{
                ...
                o.texcoor1.xyz = unity_ObjectToWorld._m03_m13_m23 * v.vertex.www + tmp0.xyz;
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.x = inp.texcoor1.y - _PlayerY;
                tmp0.x = tmp0.x < 0.0;
                if (tmp0.x) {
                    discard;
                }
                o.sv_target.xyz = _OccludedColor.xyz;
                o.sv_target.w = 1.0;
                return o;
			}
			ENDCG
