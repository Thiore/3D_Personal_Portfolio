	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.xyz = tmp0.yzw * tmp1.xyz + tmp2.xyz;
                tmp0.w = inp.texcoord2.y - _HeightStart;
                tmp0.w = saturate(tmp0.w / _HeightMax);
                tmp0.xyz = tmp0.xyz - _FadeColor.xyz;
                o.sv_target.xyz = tmp0.www * tmp0.xyz + _FadeColor.xyz;
                o.sv_target.w = 1.0;
                return o;
			}
			ENDCG
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1.w = 1.0 - _Saturation;
                tmp2.xyz = -tmp2.xyz * _Color.xyz + tmp0.www;
                ...
                tmp0.w = inp.texcoord2.y - _HeightStart;
                tmp0.w = saturate(tmp0.w / _HeightMax);
                tmp0.xyz = tmp0.xyz * tmp1.xyz + -_FadeColor.xyz;
                o.sv_target.xyz = tmp0.www * tmp0.xyz + _FadeColor.xyz;
                o.sv_target.w = 1.0;
                return o;
			}
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.x = inp.texcoord2.y - _HeightStart;
                tmp0.x = saturate(tmp0.x / _HeightMax);
                o.sv_target.xyz = tmp1.xyz * tmp0.xxx;
                o.sv_target.w = 1.0;
                o.sv_target1.w = _Glossiness;
                o.sv_target2.xyz = inp.texcoord1.xyz * float3(0.5, 0.5, 0.5) + float3(0.5, 0.5, 0.5);
                o.sv_target2.w = 1.0;
                tmp0.yzw = float3(1.0, 1.0, 1.0) - _FadeColor.xyz;
                o.sv_target3.xyz = tmp0.xxx * tmp0.yzw + _FadeColor.xyz;
                o.sv_target3.w = 1.0;
                return o;
			}
			ENDCG
