	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.xyz = tmp0.xyz * _MainAlpha.xxx;
                tmp0.xyz = tmp0.xyz * _TintColor.xyz;
                tmp1.xy = inp.texcoord3.xy / inp.texcoord3.ww;
                tmp1 = tex2D(_ReflectionTex, tmp1.xy);
                tmp1.xyz = tmp0.www * tmp1.xyz;
                tmp2.xyz = _AltReflectionColorNight.xyz - _AltReflectionColor.xyz;
                tmp2.xyz = _Night.xxx * tmp2.xyz + _AltReflectionColor.xyz;
                tmp1.xyz = tmp1.xyz * _ReflectionAlpha.xxx + -tmp2.xyz;
                tmp1.xyz = _ReflectTween.xxx * tmp1.xyz + tmp2.xyz;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1.xyz = tmp1.xyz * _MainAlpha.xxx;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp2.xyz = tmp2.xyz * _MainAlpha.xxx;
                tmp2.xyz = tmp2.xyz * _TintColor.xyz;
                tmp3.xyz = _AltReflectionColorNight.xyz - _AltReflectionColor.xyz;
                tmp3.xyz = _Night.xxx * tmp3.xyz + _AltReflectionColor.xyz;
                tmp1.xyz = tmp1.xyz * _ReflectionAlpha.xxx + -tmp3.xyz;
                tmp1.xyz = _ReflectTween.xxx * tmp1.xyz + tmp3.xyz;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                o.sv_target2.w = 1.0;
                tmp0.xy = inp.texcoord3.xy / inp.texcoord3.ww;
                tmp1 = tex2D(_ReflectionTex, tmp0.xy);
