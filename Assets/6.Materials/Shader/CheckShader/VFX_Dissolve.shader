	...
	SubShader {
		...
		Pass {
			...
			v2f vert(appdata_full v)
			{
                ...
                o.texcoord.zw = v.texcoord.xy * _SliceGuide_ST.xy + _SliceGuide_ST.zw;
			...
			fout frag(v2f inp)
			{
                ...
                float4 tmp1;
                float4 tmp2;
                tmp0 = tex2D(_SliceGuide, inp.texcoord.zw);
                tmp0.x = tmp0.x - _SliceAmount;
                tmp0.y = tmp0.x < 0.0;
                if (tmp0.y) {
                    discard;
                }
                ...
                tmp0.x = tmp0.x < _BurnSize;
                tmp1.x = _SliceAmount > 0.0;
                tmp0.x = tmp0.x ? tmp1.x : 0.0;
                tmp1.xyz = _BurnColor.xyz * _Glow.xxx;
                tmp1.xyz = tmp0.xxx ? tmp1.xyz : 0.0;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1 = tex2D(_SliceGuide, inp.texcoord.zw);
                tmp0.w = tmp1.x - _SliceAmount;
                tmp0.w = tmp0.w < 0.0;
                if (tmp0.w) {
                    discard;
                }
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.y = _SliceAmount > 0.0;
                tmp0.x = tmp0.y ? tmp0.x : 0.0;
                tmp0.yzw = _BurnColor.xyz * _Glow.xxx;
                tmp0.xyz = tmp0.xxx ? tmp0.yzw : 0.0;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1 = tex2D(_MainTex, inp.texcoord.xy);
                o.sv_target.xyz = tmp1.xyz * _Color.xyz;
                o.sv_target.w = 1.0;
