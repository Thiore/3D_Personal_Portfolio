	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp2.xyz = tmp2.xyz * _GlowStrength.xxx;
                ...
                tmp2.xyz = tmp2.xyz * _Alpha.xxx;
                o.sv_target.w = _Alpha * 0.96 + 0.04;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp3.xyz = tmp3.xyz * _GlowStrength.xxx;
