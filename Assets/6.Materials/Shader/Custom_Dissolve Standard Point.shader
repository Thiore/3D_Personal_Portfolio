	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1 = tex2D(_DissolveTex, inp.texcoord.xy);
                tmp1.yzw = _SourcePoint - inp.texcoord2.xyz;
                tmp0.w = dot(tmp1.xyz, tmp1.xyz);
                tmp0.w = sqrt(tmp0.w);
                tmp0.w = tmp1.x * _NoiseStrength + tmp0.w;
                tmp0.w = _Radius - tmp0.w;
                tmp0.w = _DissolveAmount * 100.0 + tmp0.w;
                tmp1.x = tmp0.w < 0.0;
                if (tmp1.x) {
                    discard;
                }
                tmp1.x = dot(tmp0.xyz, float3(0.0396819, 0.4580218, 0.0060965));
                tmp1.y = 1.0 - _Saturation;
                tmp1.xzw = tmp1.xxx - tmp0.xyz;
                tmp0.xyz = tmp1.yyy * tmp1.xzw + tmp0.xyz;
                tmp0.xyz = saturate(tmp0.xyz * _Brightness.xxx);
                tmp0.xyz = tmp0.xyz * _Color.xyz;
                tmp0.w = tmp0.w < _RimWidth;
                tmp1.xyz = _CrackColor.xyz * _Glow.xxx;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp2.yzw = _SourcePoint - inp.texcoord2.xyz;
                tmp0.w = dot(tmp2.xyz, tmp2.xyz);
                tmp0.w = sqrt(tmp0.w);
                tmp0.w = tmp2.x * _NoiseStrength + tmp0.w;
                tmp0.w = _Radius - tmp0.w;
                tmp0.w = _DissolveAmount * 100.0 + tmp0.w;
                tmp1.w = tmp0.w < 0.0;
                if (tmp1.w) {
                ...
                tmp1.w = dot(tmp1.xyz, float3(0.0396819, 0.4580218, 0.0060965));
                tmp2.x = 1.0 - _Saturation;
                tmp2.yzw = tmp1.www - tmp1.xyz;
                tmp1.xyz = tmp2.xxx * tmp2.yzw + tmp1.xyz;
                tmp1.xyz = saturate(tmp1.xyz * _Brightness.xxx);
                tmp1.xyz = tmp1.xyz * _Color.xyz;
                tmp0.w = tmp0.w < _RimWidth;
                tmp2.xyz = _CrackColor.xyz * _Glow.xxx;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.x = _DissolveAmount * 100.0 + tmp0.x;
                tmp0.x = tmp0.x < 0.0;
                if (tmp0.x) {
                    discard;
                }
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                float4 tmp1;
                float4 tmp2;
                tmp0.xyz = _SourcePoint - inp.texcoord1.xyz;
                tmp0.x = dot(tmp0.xyz, tmp0.xyz);
                tmp0.x = sqrt(tmp0.x);
                tmp1 = tex2D(_DissolveTex, inp.texcoord.xy);
                tmp0.x = tmp1.x * _NoiseStrength + tmp0.x;
                ...
                tmp0.x = _DissolveAmount * 100.0 + tmp0.x;
                tmp0.y = tmp0.x < 0.0;
                tmp0.x = tmp0.x < _RimWidth;
                if (tmp0.y) {
                    discard;
                }
                tmp0.y = 1.0 - _Saturation;
                tmp1 = tex2D(_MainTex, inp.texcoord.xy);
                tmp0.z = dot(tmp1.xyz, float3(0.0396819, 0.4580218, 0.0060965));
                tmp2.xyz = tmp0.zzz - tmp1.xyz;
                tmp0.yzw = tmp0.yyy * tmp2.xyz + tmp1.xyz;
                tmp0.yzw = saturate(tmp0.yzw * _Brightness.xxx);
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.x = dot(tmp0.xyz, tmp0.xyz);
                tmp0.x = sqrt(tmp0.x);
                tmp1 = tex2D(_DissolveTex, inp.texcoord1.xy);
                tmp0.x = tmp1.x * _NoiseStrength + tmp0.x;
                tmp0.x = _Radius - tmp0.x;
                tmp0.x = _DissolveAmount * 100.0 + tmp0.x;
                tmp0.x = tmp0.x < 0.0;
