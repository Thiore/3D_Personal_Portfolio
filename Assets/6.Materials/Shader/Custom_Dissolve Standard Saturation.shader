	...
	SubShader {
		...
		Pass {
			...
			v2f vert(appdata_full v)
			{
                ...
                o.texcoord.zw = v.texcoord.xy * _DissolveTex_ST.xy + _DissolveTex_ST.zw;
			...
			fout frag(v2f inp)
			{
                ...
                float4 tmp1;
                float4 tmp2;
                tmp0 = tex2D(_DissolveTex, inp.texcoord.zw);
                ...
                tmp1.w = dot(tmp0.xyz, float3(0.0396819, 0.4580218, 0.0060965));
                tmp2.x = 1.0 - _Saturation;
                tmp1.xyz = -tmp1.xyz * _Color.xyz + tmp1.www;
                tmp0.yzw = tmp2.xxx * tmp1.xyz + tmp0.yzw;
                tmp0.x = tmp0.x < 0.0;
                tmp1.xyz = _CrackColor.xyz * _Glow.xxx + tmp0.yzw;
		...
		Pass {
			...
			v2f vert(appdata_full v)
			{
                ...
                o.texcoord1.xy = v.texcoord.xy * _DissolveTex_ST.xy + _DissolveTex_ST.zw;
