	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp3.yzw = _SourcePoint - inp.texcoord2.xyz;
                tmp1.w = dot(tmp3.xyz, tmp3.xyz);
                tmp1.w = sqrt(tmp1.w);
                tmp1.w = tmp3.x * _NoiseStrength + tmp1.w;
                tmp1.w = tmp1.w - _Radius;
                tmp1.w = saturate(1.0 - tmp1.w);
                tmp2.xyz = tmp2.xyz * _CrackColor.xyz;
                ...
                tmp3.w = 1.0 - _Glossiness;
                tmp4.w = dot(-tmp1.xyz, inp.texcoord1.xyz);
                tmp4.w = tmp4.w + tmp4.w;
                tmp5.xyz = inp.texcoord1.xyz * -tmp4.www + -tmp1.xyz;
                ...
                if (tmp5.w) {
                    ...
                    if (tmp5.w) {
                        ...
                        tmp5.xyz = tmp9.xyz * tmp5.www + tmp10.xyz;
                    }
                    ...
                    tmp7.xyz = tmp4.www * tmp7.xyz + -tmp5.xyz;
                ...
                tmp3.w = 1.0 - tmp0.z;
                tmp4.w = abs(tmp0.w) * tmp3.w + tmp0.z;
                tmp3.w = tmp1.x * tmp3.w + tmp0.z;
                tmp0.w = abs(tmp0.w) * tmp3.w;
                tmp0.w = tmp1.x * tmp4.w + tmp0.w;
                tmp0.w = tmp0.w + 0.00001;
                tmp0.w = 0.5 / tmp0.w;
                tmp3.w = tmp0.z * tmp0.z;
                tmp4.w = tmp1.y * tmp3.w + -tmp1.y;
                tmp1.y = tmp4.w * tmp1.y + 1.0;
                ...
                tmp7.xyz = float3(1.0, 1.0, 1.0) - tmp3.xyz;
                tmp0.xyw = tmp7.xyz * tmp0.xxx + tmp3.xyz;
                tmp0.xyw = tmp0.xyw * tmp6.xyz;
                tmp0.xyw = tmp4.xyz * tmp5.xyz + tmp0.xyw;
                tmp4.xyz = tmp8.xyz * tmp0.zzz;
                tmp5.xyz = tmp1.xxx - tmp3.xyz;
                tmp1.xyz = tmp1.zzz * tmp5.xyz + tmp3.xyz;
                tmp0.xyz = tmp4.xyz * tmp1.xyz + tmp0.xyw;
