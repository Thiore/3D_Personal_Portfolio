	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.yzw = _SourcePoint - inp.texcoord2.xyz;
                tmp0.y = dot(tmp0.xyz, tmp0.xyz);
                tmp0.y = sqrt(tmp0.y);
                tmp0.x = tmp0.x * _NoiseStrength + tmp0.y;
                ...
                tmp0.xyz = _CrackColor.xyz * _Glow.xxx;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                float4 tmp1;
                tmp0 = tex2D(_MainTex, inp.texcoord.xy);
                tmp0.yzw = _SourcePoint - inp.texcoord1.xyz;
                tmp0.y = dot(tmp0.xyz, tmp0.xyz);
                tmp0.y = sqrt(tmp0.y);
                tmp0.x = tmp0.x * _NoiseStrength + tmp0.y;
                tmp0.x = _Radius - tmp0.x;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                o.sv_target.xyz = _CrackColor.xyz * _Glow.xxx;
                o.sv_target.w = 1.0;
