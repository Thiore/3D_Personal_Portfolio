	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp3.xyz = tmp2.xyz * inp.color.xyz;
                ...
                tmp2.xyz = tmp2.xyz * inp.color.xyz + float3(-0.04, -0.04, -0.04);
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp4.xyz = tmp3.xyz * inp.color.xyz;
                ...
                tmp3.xyz = tmp3.xyz * inp.color.xyz + float3(-0.04, -0.04, -0.04);
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.xyz = tmp0.xyz * inp.color.xyz + float3(-0.04, -0.04, -0.04);
