	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp2 = tmp2 * _Color;
                tmp1.w = tmp2.w * _Glow;
                tmp1.w = max(tmp1.w, _RespawnGlow);
                tmp2.xyz = tmp1.www * _GlowColor.xyz + tmp2.xyz;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1.w = tmp3.w * _Glow;
                tmp1.w = max(tmp1.w, _RespawnGlow);
                tmp3.xyz = tmp1.www * _GlowColor.xyz + tmp3.xyz;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0 = tmp0 * _Color;
                tmp0.w = tmp0.w * _Glow;
                tmp0.w = max(tmp0.w, _RespawnGlow);
                tmp0.xyz = tmp0.www * _GlowColor.xyz + tmp0.xyz;
