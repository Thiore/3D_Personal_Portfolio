	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1.xy = inp.texcoord.zw + _ShineOffset.xx;
                tmp1 = tex2D(_Shine, tmp1.xy);
                tmp1.xyz = tmp1.xyz * _ShineColor.xyz;
                tmp1.xyz = tmp1.xyz * _ShineGlow.xxx;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp2.xy = inp.texcoord.zw + _ShineOffset.xx;
                tmp2 = tex2D(_Shine, tmp2.xy);
                tmp2.xyz = tmp2.xyz * _ShineColor.xyz;
