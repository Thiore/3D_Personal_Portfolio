	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1 = tex2D(_Detail, inp.texcoord.zw);
                ...
                tmp0.xyz = -tmp0.xyz * tmp1.xyz + tmp0.www;
                tmp0.xyz = tmp1.www * tmp0.xyz + tmp2.xyz;
                ...
                tmp1.yzw = g_NightFadeColor.xyz - _FadeColor.xyz;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp2 = tex2D(_Detail, inp.texcoord.zw);
                tmp2.xyz = tmp2.xyz * float3(4.0, 4.0, 4.0);
                tmp3.xyz = tmp1.xyz * tmp2.xyz;
                tmp0.w = dot(tmp3.xyz, float3(0.0396819, 0.4580218, 0.0060965));
                tmp1.w = 1.0 - _Saturation;
                tmp1.xyz = -tmp1.xyz * tmp2.xyz + tmp0.www;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp2.xyz = g_NightFadeColor.xyz - _FadeColor.xyz;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.w = 1.0 - _Saturation;
                tmp0.xyz = tmp0.www * tmp0.xyz + tmp2.xyz;
                tmp0.w = inp.texcoord2.y - _HeightStart;
                tmp0.w = saturate(tmp0.w / _HeightMax);
                ...
                o.sv_target2.w = 1.0;
                tmp0.xyz = g_NightFadeColor.xyz - _FadeColor.xyz;
                tmp0.xyz = _Night.xxx * tmp0.xyz + _FadeColor.xyz;
                tmp1.xyz = float3(1.0, 1.0, 1.0) - tmp0.xyz;
                o.sv_target3.xyz = tmp0.www * tmp1.xyz + tmp0.xyz;
                o.sv_target3.w = 1.0;
                return o;
			}
			ENDCG
